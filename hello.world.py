...
#2
a = "new"
print("%s %s%s" % ("I don't like", a, "lines"))
#3
print("I like")
print("newlines")
...
for y in grocery_list:
    print(y)
#2
for y in range(0, len(grocery_list)):
    print(grocery_list[y])
...
while (random_num != 15) or (random_num != 20):
    print(random_num)
    random_num = random.randrange(0, 100)
...
class Animal:
    ...
    __name = None  # make a variable private by starting it with __
    __height = None
    __weight = None
    __sound = None
    ...
    def __init__(self, name="Cengceng", height=30, weight=15, sound="miaomiao"):
        self.__name = name
...
class Pet:
    ...
    # The constructor is called to set up or initialize an object
    # self allows an object to refer to itself inside of the class
    def __init__(self, name="Cengceng", height=40, weight=20, sound="Miao"):
        self.ne = name
        self.ht = height
        self.wt = weight
        self.sd = sound
    ...
    def all_Description(self):
        return "{} is {} cm tall and {} kilograms and says {}".format(self.ne,
                                                                      self.ht,
                                                                      self.wt,
                                                                      self.sd)
    def happyLevel(self, temperature = 25, foodWeight = 45, sleepTime = 8):
        return "The level of happy of {} is {}".format(self.ne,
                                                       foodWeight - temperature + sleepTime)

cat = Pet()
cat = Pet('Whiskers', 33, 10, 'Meow')  # create a Pet object
